...
begin
  ...
  TNPUtils.PrintLn('  ' + COLOR_GREEN + 'init' + COLOR_RESET + ' <n>       Create a new NitroPascal project');
  ...
  TNPUtils.PrintLn('  ' + COLOR_CYAN + 'nitro init MyGame' + COLOR_RESET + '  Create a new game project');
...
begin
  ...
  begin
    ...
    TNPUtils.PrintLn('');
    TNPUtils.PrintLn('Usage: ' + COLOR_CYAN + 'nitro init <n>' + COLOR_RESET);
    TNPUtils.PrintLn('');
  ...
  //LBaseDir := GetCurrentDir() + PathDelim + LProjectName;
  LBaseDir := GetCurrentDir() + PathDelim;

  TNPUtils.PrintLn('');
  GCompiler.Init(LProjectName, LBaseDir);
  TNPUtils.PrintLn('');
