...
begin
  ...
  for LI := 0 to 9 do
  begin
    if Byte(Pointer(Integer(LPtr) + LI)^) = 0 then
      Inc(LSize);
  end;
  ...
  WriteLn('First element: $', IntToStr(LByteArray[0]));
  WriteLn('Last element: $', IntToStr(LByteArray[99]));
  ...
  { Verify fill }
  WriteLn('First element: $', IntToStr(LByteArray[0]));
  WriteLn('Element 50: $', IntToStr(LByteArray[50]));
  ...
  { Verify fill }
  WriteLn('First element: $', IntToStr(LWordArray[0]));
  WriteLn('Last element: $', IntToStr(LWordArray[9]));
  ...
  { Verify fill }
  WriteLn('First element: $', IntToStr(LDWordArray[0]));
  WriteLn('Middle element: $', IntToStr(LDWordArray[5]));
