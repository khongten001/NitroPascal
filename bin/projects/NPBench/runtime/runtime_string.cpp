...
String::String(char16_t ch) : data_(1, ch) {
}
...
String String::operator+(char16_t ch) const {
    return String(data_ + std::u16string(1, ch));
}
...
bool String::operator==(char16_t ch) const {
    return data_.length() == 1 && data_[0] == ch;
}
