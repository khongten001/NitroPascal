...
public:
    ...
    String(char16_t ch);  // Single character constructor
    ...
    String operator+(char16_t ch) const;
...
// Character comparison operators (for reverse order comparisons)
inline bool operator==(char16_t ch, const String& str) {
    return str == ch;
}
...
inline String operator+(char16_t ch, const String& str) {
